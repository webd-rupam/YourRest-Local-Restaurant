  ...
  return (
    <div className='w-full min-h-[51vh] overflow-x-hidden flex flex-col justify-between md:pt-20 pt-16 px-6 md:px-20 lg:px-40 bg-black text-white relative z-40'>
       ...
       <div className='w-full md:w-1/2 lg:w-1/3 mb-6 md:mb-0'>
         <h4 className='text-xl font-bold'>YourRest</h4>
         <p className='text-sm mt-4 md:mt-6 mb-6 lg:mr-10'>
         Savor every moment with YourRest. From indulging in delightful cuisines to the convenience of ordering and secure payments online. Whether at our restaurant or the comfort of your home, let us make every meal memorable. Taste the difference today!
         </p>
       </div>
